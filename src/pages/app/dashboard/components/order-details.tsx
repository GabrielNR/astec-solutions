...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Serviço: 1827fy2827d6h</DialogTitle>
      ...
      <div className="space-y-6">
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              <TableCell className="text-muted-foreground">Equipament</TableCell>
              <TableCell className="flex justify-end">
                Celular Motog9 power
              </TableCell>
            </TableRow>
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>A bateria não estava carregando corretamente e se descarregava muito rapidamente.</TableCell>
